...
# ╔═╡ 9e8d52a4-a780-4fe1-9ef7-00337f5ea4f4
begin
	using MFCC
	using WAV
	using Plots
...
# ╔═╡ de845e5a-bbfb-4afb-8939-d29e78f1f847
y, freq = wavread("./file/ai_arigatougozaimasita.wav")

# ╔═╡ 76fe24a0-d44f-43af-bf4e-95b933992865
freq

# ╔═╡ 1f671bf5-0de1-47d9-9603-02bebc369324
y_mfcc = mfcc(y)

# ╔═╡ b9e92013-b66c-4c41-80fb-08715941e830
length(y_mfcc[1][1, :])

# ╔═╡ fb134586-2361-46a9-a4dc-a7415d926708
y_mfcc[1][1, :]

# ╔═╡ d658240d-5c46-4552-89a0-245f1e1d4638
plot(y_mfcc[1][1, :])
